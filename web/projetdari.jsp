<%-- 
    Document   : projetdari
    Created on : 28 mars 2016, 11:20:33
    Author     : Office Info
--%>
...
<head>
    ...
    <title>1/3 votre projet immobilier Dari</title>
	<!-- BOOTSTRAP STYLES-->
             ...
             <br><div class="col-md-8">                   
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" class="pull-center">
                            <span class="pull-left"><img src="assets/img/3_1.png"/></span><tr><h2 class="pull-center"> Votre projet Immobilier Dari</h2></tr>
                            ...
                            <span class="pull-center">
                                      ...
                                      <select  class="form-control" > 
                                          ...
                                          <option>projet de vacance</option>
                                     <option>projet de travaux</option>
                                      <option>projet de voituret</option> 
                                      <option>projet de mariage</option>
                                      <option>anticipation de l'arrivée de bébé</option> 
                                      </select>
                        ...
                        <a class="btn btn-primary btn-lg" role="button">CONTINUER</a>
                               </div>
                    </div>            
                 ...
                 <span class="pull-right" ><img src="assets/img/dem.jpg"/></span>
                                        </div>
