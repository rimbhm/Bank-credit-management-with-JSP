        ...
        String client =session.getAttribute("login").toString();
         int num =Integer.parseInt(request.getParameter("num"));
           ...
           <div class="panel-body" class="pull-center">
                            ...
                            <form role="form"  methode ="Post" action="modifdema">
                      ...
                      <br><label>*Situation familiale</label>
                               <select class="form-control" name ="situation" value="<%=c.getSituation()%>">
                           ...
                           <input type="text" class="form-control" name ="pers" value="<%=c.getPers()%>"/>
                            <br><label> *Situation Logement</label>
                                <select name ="logement" class="form-control" value="<%=c.getLogement()%>">
                            ...
                            <option>Autre</option>
                               ...
                               <input type="text" name= "prof" class="form-control" value="<%=c.getProf()%>" />
                                <br><label>*Statut professionnel</label>
                                    <select name="statut" class="form-control" value="<%=c.getStatut()%>">
                                        <option>Salarie public</option>
                                        <option>Salarie prive</option>
                                        <option>Autre et retraite</option>
                                    </select>
                                    <br><label>*Durée d'activité</label>
                                           <input type="text" name = "duree" class="form-control" value="<%=c.getDuree()%>"/>  
                                    <hr>
                             <h4>Vos Revenus</h4>
                                      <h5> saissez le chiffre 0 si un champ ne vous concerne pas.</h5>
                                       <br><label>*Salaire mensuel net</label>
                                  <input type="text" name = "salaire" class="form-control" value="<%=c.getSalaire()%>"/>  
                                    <br><label> *Revenu non salarié(Pension de retraite)</label>
                               <input type="text" name = "revenu" class="form-control" value="<%=c.getRevenu()%>" />
                           <br><label>*Loyer mensuel percu </label>
                           <input type="text" name = "loyer" class="form-control" value="<%=c.getLoyer()%>"/>
                           <br><label> *Autre revenus mensuels </label>
                           <input type="text" name = "arm" class="form-control" value="<%=c.getArm()%>" />
                           
                                 <hr>
                          <h4>Vos Charges</h4>
                               <h5> saissez le chiffre 0 si un champ ne vous concerne pas.</h5>
                               <br><label> *Montant du loyer à payer(si locataire)</label>
                           <input type="text" name = "mloyer" class="form-control" value="<%=c.getMloyer()%>" />
                          
                            <br><label> *Mensualité des crédits UIB </label>
                                <input type="text" name = "mcred" class="form-control" value="<%=c.getMcred()%>"/>
                            <br><label> *Encours des crédits UIB </label>
                             <input type="text" name = "enc_cred" class="form-control" value="<%=c.getEnc_cred()%>" />
                             <br><label> *Montant</label>
                               <input type="text" name = "montant_cred" class="form-control" value="<%=c.getMontant_cred()%>"/>
                           <br><label>*Durée </label>
                           <input type="text" name = "duree_cred" class="form-control" value="<%=c.getDuree_cred()%>"/>
