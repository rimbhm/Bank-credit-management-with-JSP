<%-- 
    Document   : dari
    Created on : 27 mars 2016, 20:06:31
    Author     : Office Info
--%>
...
%></div>
 ...
 Espace Client </a>
                    ...
                    <li>
                        <a href="client.jsp" class="active-menu" ><i class="fa fa-money fa-3x"></i> Nos Crédits Consommation<span class="fa arrow"></span></a>
 ...
 Simulation</a>
                     ...
                     <li>
                        <a href="demdari.jsp" href="#"><i class="fa fa-edit fa-3x"></i> Faire votre demande<span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                       ...
                       <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><h2>Le crédit Immobilier Dari UIB Direct, un crédit clair et compétitif </h2></a>
                                        </h4>
                                    </div>
                        ...
                        <cebter><h2> Simulez votre crédit Immobilier Dari </h2></center>
                                ...
                                <div class="tab-pane fade active in" id="home">
                                      ...
                                      <div class="form-group">
                                          <br><label> Vos Revenus mensuels nets</label> 
                                           ...
                                           <br><label>Durée souhaiteé de prêt </label>                                           
               ...
               <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><h2>Quels sont les critères du crédit Immobilier Dari</h2></a>
                                        </h4>
                                    </div>
                                    <div id="collapseTwo" class="panel-collapse in" style="height: auto;">
                                        <div class="panel-body">
                                            <strong> Pour qui?</strong>
                                            <p>Le crédit Immobilier Dari  est potentiellement accessible à toute salarié titulaire du secteur public, du secteur privé avec 
                         ...
                         <p>L'acquisition de logement ou de terrain à usage d'habitation.
                         Construction ou extension de logement.</p>
                         <strong> Pour quel montant?</strong>
                        <p>le souscripteur peut bénéficier d'un crédit Dari anticipé aprés au moins une année d'épargne, quelle que soit la durée initiale.
                            le montant du crédit anticipé peut sera égal au maximum à 5 fois l'épargne régulière constituée à cette date
                        par exemple de 5 000 à 250 000 DT</p>
