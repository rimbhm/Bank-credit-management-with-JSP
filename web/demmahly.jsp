<%-- 
    Document   : demmahly
    Created on : 27 mars 2016, 15:36:49
    Author     : Office Info
--%>
...
<head>
    ...
    <title>Demande de crédit Immobilier Mahly</title>
	<!-- BOOTSTRAP STYLES-->
...
font-size: 16px;"><form method="post" action="logout">
 ...
 Simulation</a>
                    ...
                    <li>
                        <a  href="demmhaly.jsp" class="active-menu"><i class="fa fa-edit fa-3x"></i> Faire votre demande </a> </li>  
                 
                    <li>
                        <a  href="suividem.jsp"><i class="fa fa-edit fa-3x"></i> Suivi de votre demande </a> </li>  
        ...
        String client =session.getAttribute("login").toString();
           %>
                        ...
                        <label>*Type de Crédit</label>
                                  <input type="text" name ="credit" value="Mahly" class="form-control"/>
