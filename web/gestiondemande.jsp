     ...
     <div id="page-wrapper" >
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center><strong>  Liste des demandes </strong></center>
                        </div>
		...
		try {
			...
			conn = DriverManager.getConnection(url, "root", "");
                        ...
                        String query ="select * from demande where etat = 'en cours' "; 
                                        ...
                                        <tr class="odd gradeX">
                                         ...
                                         <td><%=rs.getString(3)%></td>
                                          ...
                                          <td><%=rs.getString(9)%></td>
                                           ...
                                           <td><center>
                                   <a href ='accepter.jsp?num=<%=rs.getString(1)%>' >  <button type="button" class="btn btn-success btn-circle " ><i class="fa fa-check"></i>
                                       </button></a>
                               <a href ='affdemanderesp.jsp?num=<%=rs.getString(1)%>' ><button type="button" class="btn btn-info btn-circle "><i class="fa fa-eye"></i>
                                   </button></a>
                               <a href ='refuser.jsp?num=<%=rs.getString(1)%>' >  <button type="button" class="btn btn-danger btn-circle "><i class="fa fa-trash"></i>
                                   </button></a></center>
                                   </td>       
                                        </tr>
                                            <%
