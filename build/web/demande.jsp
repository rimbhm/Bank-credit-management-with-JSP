...
<head>
    ...
    <title>Faire votre demande de crédit</title>
	<!-- BOOTSTRAP STYLES-->
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li  >
                        <a   href="client.jsp"><i class="fa fa-male fa-3x" ></i> Espace Client </a>
                    </li>				
            ...
            <div id="page-inner">
                       ...
                       <div class="panel panel-default">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse in" style="height: auto;">
                                        <div class="panel-body">
                                            <h4>Remplissez notre formulaire en 5 minutes si vous etes rapide!
                        </h4>
             ...
             <br><div class="col-md-8">                   
                    <div class="panel panel-default">
                        ...
                        <a href="demprojet.jsp"class="btn btn-primary btn-lg" role="button">CONTINUER</a>
                               </div>
                    </div>            
