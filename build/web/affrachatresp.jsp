        ...
        client p =new client();
         ...
         String nom= c.getClient();
           ...
           <div class="panel-body" class="pull-center">
            <span class="pull-left"><img src="assets/img/r.png"/></span><tr><h2 class="pull-center"> Demande de rachat de crédit numéro <%=num%> </h2></tr>
                      
          
           
           <div class="panel panel-primary">
                        <div class="panel-heading">
                           Informations sur la demande de rachat de crédit 
                        </div>
                        <div class="panel-body">
                         ...
                         <div class="tab-pane fade" id="profile">
                           ...
                           <input type="text" name = "mloyer" class="form-control" value="<%=c.getMloyer()%>" disabled/>
                                ...
                                <div class="tab-pane fade" id="settings">
                                 <br><label> Type de crédits UIB </label>
                                <input type="text" name = "credit" class="form-control" value="<%=c.getCredit()%>" disabled/>
                                <br><label>Capital Restant en(DT) </label>
                                 <input type="text" name = "capitale" class="form-control" value="<%=c.getCapitale()%>" disabled/>
                                  <label> Mensualité de crédit  hors UIB actuel</label>
                               <input type="text" name = "mens" class="form-control" value="<%=c.getMens()%>" disabled/>
                                 <br>
                               <label>Montant du nouveau crédit </label>
                               <input type="text" name = "montant" class="form-control" value="<%=c.getMontant()%>" disabled=""/>
