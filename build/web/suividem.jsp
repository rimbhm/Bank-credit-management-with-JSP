...
<form method="post" action="logout">
     ...
     <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Table de suivi des demandes de crédit</h2>   
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center><strong>  Suivi de mes demandes </strong></center>
                        </div>
                        ...
                        while (rs.next())
                        {
                                        ...
                                        <tr class="odd gradeX">
                                         ...
                                         <td><%=rs.getString(18)%></td>
                                           ...
                                           <% 
                                               String n= rs.getString(18).toString();
                                               if(n.equals("Acceptation") ){
                                                 %>
                                                 
                                                 <td><center> <a href ='amor.jsp?num=<%=rs.getString(1)%>' >Tableau d'amortissement</a></center></td>
                                        
                                                 
                                                 
                                         <%  } else {%>
                                 <td><center> Demande rejeté :( </center></td>
