<%-- 
    Document   : dempojet
    Created on : 17 mars 2016, 22:55:18
    Author     : Office Info
--%>
...
<head>
    ...
    <title>1/3 votre projet Auto UIB Direct</title>
	<!-- BOOTSTRAP STYLES-->
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a href="CrdImmobilierMahly">Immobilier Mahly</a>
                                    </li>
                       ...
                       <div class="panel panel-default">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse in" style="height: auto;">
                                        <div class="panel-body">
                                            <h4>Remplissez notre formulaire en 5 minutes si vous ete rapide!
                        </h4>
             ...
             <br><div class="col-md-8">                   
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" class="pull-center">
                            <span class="pull-left"><img src="assets/img/3_1.png"/></span><tr><h2 class="pull-center"> Votre projet Auto</h2></tr>
                           ...
                           <br><label> *Bien </label>
                               <select class="form-control"> <option>Neuf</option>
                                   <option>D'occasion</option>
                               </select>
                           <br><label> *Montant du bien TTC</label>
                               <input class="form-control" />
                           <br><label> *Date de mise en circulation</label>
                               <input class="form-control" placeholder="JJMMAAAA"/>
                           </span></br>
                        <a class="btn btn-primary btn-lg" role="button">VALIDER</a>
                               </div>
                    </div>            
